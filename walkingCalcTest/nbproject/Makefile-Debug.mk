...
${OBJECTDIR}/_ext/352903889/Matrix3f.o: ../walkingCalcTest/Matrix3f.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/352903889/Matrix3f.o ../walkingCalcTest/Matrix3f.cpp
...
${OBJECTDIR}/WalkingAnimator.o: WalkingAnimator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/WalkingAnimator.o WalkingAnimator.cpp
